...
type_list = [
	...
	["com", "Fraccionarios" ,"com/compresorFrac.png", "<b>Línea de compresores fraccionarios Embraco - Aspera</b></br>\n - Compresores para media y baja temperatura con gas R-134a.R-22; R-507 O R-404\n - Modelos en 220 V a 50 Hz.\n - Modelos de 1/6+ a 1.5 HP.\n- Rendimiento de +5°C a -35°C. \n </br><b>Línea de compresores fraccionarios Danfoss:</b></br> \n - Compresores para alta, media y baja temperatura con gas R-134a R-507\n - Modelos en 220 V a 50 Hz.\n - Modelos de 1/4+ a 3/4+ HP.\n - Rendimiento de +15°C a -35°C. "],
	["eva", "Evaporadores" ,"evap/evap1.png", "Nuestros evaporadores de alta eficiencia están fabricados con aletas de aluminio y tubo de cobre de 12mm de alta calidad, los intercambiadores de calor se suministran limpios y probados con una presión de 30 bars.</br>\n De aluminio pintado blanco al polvo electrostático, con alta resistencia contra la corrosión y los impactos.</br>\n Sistema de desescarche por resistencias eléctricas de acero inoxidable enfundadas en tubos de aluminio localizados en el paquete aleteado y en la bandeja de desagüe. "],
	["con", "Condensadores" ,"cond/con1.png" , "Nuestros condensadores de alta eficiencia, están fabricados con aletas de aluminio y tubo de cobre de 9.52mm de alta calidad.  Los intercambiadores de calor se suministras limpios en el interior de las tuberías y con una prueba de presión de 30bars.</br>\n La carcaza de acero galvanizado pintado en negro al polvo electrostático, con alta resistencia contra la corrosión y resistente a los impactos no produce residuos tóxicos. </br>\n Los ventiladores con motor axial y rotor externo, con alto estándar de seguridad y anclados a la carcaza."],
	...
	["ace" , "Sintético Emkarate", "ace/aceEmkarate.jpg", "<b>Aceite sintético Emkarate</b></br>\n -RL-32 CF y RL 1009\n -En tarros de 1 y 4 litros\n -Aceite diseñado para refrigerantes ecológicos.\n -Fabricados en USA</br>\n Completo stock para entrega inmediata."],
	...
	["cyb" , "Cierres y Bisagras", "cyb/cyb1.png", "La gama de cerrojos, bisagras y cierres de correderas, dispuestos en nuestra instalación, cubren la gran demanda que exige el mercado actual manteniendo un variado stock para instalaciones comerciales, semi industriales e Industriales.</br>\n Importamos nuevos productos para ofrecer una mejor calidad de estos a nuestros clientes."],
